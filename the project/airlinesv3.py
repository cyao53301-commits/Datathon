...
df = pd.read_excel("C:/Users/Soham Dhar/IdeaProjects/untitled/the project/airline_cleaned.xlsx", engine="openpyxl")
...
#==============================================================
# Time-series hyperparameter tuning, early stopping code
#==============================================================

# -------------------------------------------------------------
# Hyperparameter search (NO early stopping here)
# -------------------------------------------------------------
...
# -------------------------------------------------------------
# Time-aware validation split (NO leakage)
# -------------------------------------------------------------

val_cutoff = 2024

train_xgb = df[df["Year"] < val_cutoff]
val_xgb = df[df["Year"] == val_cutoff]
...
print("Best boosting round:",
      xgb.best_iteration)

# -------------------------------------------------------------
# Final evaluation on test set (Year >= 2025)
# -------------------------------------------------------------

xgb_preds = xgb.predict(X_test)

print("Final XGB RMSE:",
